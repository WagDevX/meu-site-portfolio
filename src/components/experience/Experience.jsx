            ...
            <div className="experience__content">
              ...
              <article className="experience__details">
                ...
                <div>
                  <h4>TailwindCSS</h4>
                  <small className="text-light">
                    {expTranslations.front_tailwind}
                  </small>
                </div>
              </article>
              <article className="experience__details">
