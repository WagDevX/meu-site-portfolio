...
const translations = {
  en: {
    ...
    courses_h5: "Courses",
    courses_sm: "3+ Courses",
    projects_h5: "Projects",
    projects_sm: "5+ Projects",
    ...
    front_html: "Intermediate",
    front_js: "Learning process",
    front_react: "Intermediate",
    front_css: "Intermediate",
    front_kvlang: "Intermediate",
    back_python: "Experienced",
    back_node: "Learning process",
    back_kivy: "Intermediate",
    back_firebase: "Experienced",
    back_post: "Intermediate",
    ...
    services_webl5:"Static or dymanic websites.",
    services_webl6:"Totally open to constructive feedbacks.",
    services_apps_h3: "App Development",
    services_appsl1: "Devepelopment with Python KivyMD.",
    services_appsl2: "Integration with databases.",
    services_appsl3: "UI Designs with KivyMD Widgets.",
    services_appsl4: "Complete systems with login a register.",
    services_appsl5: "Rapid development with Kivy.",
    portfolio_h5: "My recent works",
    portfolio_h2: "Portfolio",
    portfolio_1_title: "WorkTasks - Python KivyMD App with firebase",
    portfolio_2_title: "TikTok Clone with react and nodejs",
  ...
  pt: {
    ...
    front_html: "Itermediário",
    front_js: "Estudando",
    front_react: "Itermediário",
    front_css: "Itermediário",
    front_kvlang: "Itermediário",
    back_python: "Experiente",
    back_node: "Estudando",
    back_kivy: "Itermediário",
    back_firebase: "Experiente",
    back_post: "Itermediário",
    ...
    services_appsl1: "Desenvolvimento com Pyhon KivyMD.",
    services_appsl2: "Integração com banco de dados.",
    services_appsl3: "Desing UI com Widgets do KivyMD",
    services_appsl4: "Sistemas completos com login e cadastro",
    services_appsl5: "Desenvolvimento ágil com Kivy",
    portfolio_h5: "Trabalhos recentes",
    portfolio_h2: "Portfólio",
    portfolio_1_title: "WorkTasks - Python KivyMD App com firebase",
    portfolio_2_title: "TikTok Clone com react",
...
const App = () => {
  ...
  return (
    <>
        ...
        <Translation currentLanguage={currentLanguage} onLanguageChange={handleLanguageChange} />
        <Nav />
        <About translations={translations} currentLanguage={currentLanguage}/>
        <Experience translations={translations} currentLanguage={currentLanguage}/>
        <Services translations={translations} currentLanguage={currentLanguage}/>
        <Portfolio translations={translations} currentLanguage={currentLanguage}/>
